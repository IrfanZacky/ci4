...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="row mb-3">
                <div class="col-sm-10">
                    <a href="/admin/tambah/penyewaan" class="btn btn-primary">Tambah Data</a>
                </div>
            </div>
            <div class="card mb-4">
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($penyewaan as $p) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/penyewaan/edit/<?= $p['id']; ?>" class="btn btn-primary">Edit</a>
                                        <form action="/penyewaan/<?= $p['id']; ?>" method="post" class="d-inline">
                                            <?= csrf_field(); ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h6>Waktu Sewa : <?= $p['waktu_sewa']; ?></h6>
                            <h6>Waktu Kembali : <?= $p['waktu_kembali']; ?></h6>
                            <h6>Harga : <?= $p['harga']; ?></h6>
                        </div>
